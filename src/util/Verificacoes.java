...
public class Verificacoes {
    /**
     * Verifica se esta vazio. Se sim, pinta o fundo de vermelho
     * Aceita JTextField, JFormattedTextField e JPasswordField
     * @param txt
     * @return 
     */
    ...
    /**
     * Pesquisa se há um código(valor) conforme campo pesquisado, na tabela pesquisada
     * Campo = "select CAMPO" da tabela
     * Tabela do banco de dados
     * Valor = "where CÓDIGO = VALOR" id
     * EXEMPLO: PADRÂO - select CAMPO from TABELA where CODIGO VALOR
     * EXEMPLO: -------- select NOME from USUARIO where CODIGO 1
     * @param campo
     * @param tabela
     * @param valor
     * @return 
    ...
    /**
     * Pesquisa o valor de um ID de uma tabela/chave estrangeira
     * Campo ("nome") = "select CAMPO" da tabela
     * Tabela (usuario) do banco de dados
     * Valor ("1") = "where CÓDIGO = VALOR" id
     * EXEMPLO: PADRÂO - select CAMPO from TABELA where CODIGO VALOR
     * EXEMPLO: -------- select NOME from USUARIO where CODIGO 1
     * @param campo
     * @param tabela
    ...
    /**
     * Verifica se o que está sendo pressionado é número, se não for ele não automaticamente deleta o que é digitado
     * @param evt 
     */
